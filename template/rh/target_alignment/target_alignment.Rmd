...
This report summarizes non-synonymous SNPs and small INDELs identified from trio samples. Variants are selected based on genetic models, such as de novo, autosomal recessive, and X-linked; as well as their features, such as impact, allele frequency, and known disease association. 
</div>
