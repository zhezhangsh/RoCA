---
title: "Compare and combine multiple sets of test statistics"
...
**Introduction** This procedure compares and combines multiple sets of test statistics generated from the same variables measured. 
...
`r OrderTable()` Write the table title and caption here.
</div>
...
<div style="color:darkblue">
`r OrderFigure()` Write the figure caption here. 
</div>
