...
fn.zip<-paste(rev(strsplit(path, '/')[[1]])[1], '.zip', sep='');
```
...
Click links to go directly to results, or read through the rest of this page for details: 
  ...
  - Click to download
    - [Excel](`r fn.xls`) file with statistical tables 
    - [Zip](`r fn.zip`) file with complete results.
...
if (!identical(NA, ex.bic)) {
  ...
  ln<-paste("<div align='center'>![](", ex.bic, ")</div>", sep='');
} else ln<-"<div align='center'>No bicluster found</div>";
```
