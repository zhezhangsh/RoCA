...
Sequence reads were filtered by the following steps to keep those
  ...
  - with the ***FLAG*** field of SAM format having one of these values: _83; 99_.
  - with the ***MAPQ*** field of SAM format having values greater than or equal to ***20, 30***. 
  - with at least ***20, 30*** mapped bases based on the ***CIGAR*** field of SAM format.
