...
**Introduction** This analysis compares a set of high-throughput sequencing libraries based on their [FastQC](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/) reports. Please refer to the original FastQC documentation for detailed explanation about the statistics and figures in these reports. This analysis only requires the _fastqc.zip_ file from each FastQC run and a _YAML_ file providing the run specifications.
