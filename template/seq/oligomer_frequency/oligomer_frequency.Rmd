...
This analysis reports of the frequency of oligomers in DNA sequences and compare the observed frequency to expected frequency. 
  ...
  - Over- or under-representation of oligomers is calculated as the ratio of their observed frequency over expected frequency, and tested by comparing two proportions. (Wilson, E.B. (1927). Probable inference, the law of succession, and statistical inference. Journal of the American Statistical Association, 22, 209–212.)
</div>
